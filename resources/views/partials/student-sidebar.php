<aside class="d-flex flex-column align-items-center py-4 bg-surface border-end shadow-sm z-3 flex-shrink-0 transition-all" style="width: 80px;">
    ...
    <nav class="d-flex flex-column gap-3 w-100 align-items-center">
        <a href="/student/dashboard" class="btn btn-link text-secondary hover-text-primary p-3 rounded-3 position-relative group" aria-label="Dashboard">
            <span class="material-symbols-outlined fs-3">dashboard</span>
        </a>
        <a href="/student/exams" class="btn btn-link text-primary bg-primary-soft p-3 rounded-3 position-relative group" aria-label="Exams">
            <span class="material-symbols-outlined fs-3 filled">description</span>
        </a>
        <a href="/student/results" class="btn btn-link text-secondary hover-text-primary p-3 rounded-3 position-relative group" aria-label="Results">
            <span class="material-symbols-outlined fs-3">bar_chart</span>
        </a>
        <a href="/student/settings" class="btn btn-link text-secondary hover-text-primary p-3 rounded-3 position-relative group" aria-label="Settings">
